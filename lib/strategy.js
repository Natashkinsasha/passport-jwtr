...
JWTRStrategy.prototype.authenticate = function (req, options) {
    ...
    var jsonWebTokenOptions = options.JWTOptions || {};
    var verifOpts = Object.assign({}, self._verifOpts, jsonWebTokenOptions);
    return self._jwtr.verify(token, self._secretOrKey, verifOpts, function (jwt_err, payload) {
        if (jwt_err) {
